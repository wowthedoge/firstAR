...
namespace UnityEngine.XR.Interaction.Toolkit.Samples.StarterAssets
{
    ...
    /// Will run automatically OnEnable in the editorectly using shadergraph shaders, others do not and using the standard shader resolves various rendering issues.
    /// </summary>
